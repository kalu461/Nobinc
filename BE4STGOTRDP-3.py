...
# ---------------------------SNAPPY
TOKENS = [
    "8339306012:AAFcC9QGmgNv2hHFTrUXyj_h76VTubv8whU",
    "8350480416:AAFdIleQoAPaB6CxU-eICnGC8-OxQ_Y1gAI", 
    "8597007269:AAFThcBCor7eqHtJPoNzGarbdTnquX8JyeM",
    "8288989734:AAEwhZZcS2sToXkflyI_6bePtglVxUIG9bU",
    "8471782930:AAFQEoEgvxGvdL0gjwO75rcXRmo830ag1FU",
    "8487007114:AAGv78Xe0DbD-LkXtQK4zk0DBe-298KbKGs"
]
...
RAID_TEXTS = [
    ...
    "zenx की माँ मारेगी", "tbkc", "चल तेरी माँ की चुत", "exo बाप🗿🌙💯💯"
]
...
async def run_all_bots():
    ...
    print(f"🎉 SNAPPY V4 Ultra Multi is running with {len(bots)} bots!")
